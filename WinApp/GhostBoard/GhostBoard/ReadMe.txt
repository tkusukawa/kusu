================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: GhostBoard プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した GhostBoard には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには GhostBoard アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
GhostBoard.h
   ...
   CGhostBoardApp アプリケーション クラスを宣言します。

GhostBoard.cpp
   これは、アプリケーション クラス CGhostBoardApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\GhostBoard.ico
   ...
   アイコンはメイン リソース ファイル GhostBoard.rc に含まれていま
   す。
...
GhostBoardDlg.h, GhostBoardDlg.cpp - ダイアログ
   これらのファイルは CGhostBoardDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な GhostBoard.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   GhostBoard.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
